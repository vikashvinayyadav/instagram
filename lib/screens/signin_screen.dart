 ...
 bool isLoading =false;
  @override 
    ...
    signUpUser(){
       ...
       final result = AuthMethods().signUpUser(email:_emailController.text, username:_usernameController.text, name:_nameController.text, password:_passwordController.text);
        if(result =='success'){
           setState(() {
              isLoading = false;
           });
